...
pub struct CollectionSearchResponse {
    ...
    pub payload: ::protobuf::RepeatedField<CollectionId>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl CollectionSearchResponse {
    ...
    // Param is passed by value, moved
    pub fn set_payload(&mut self, v: ::protobuf::RepeatedField<CollectionId>) {
        self.payload = v;
    }

    // Mutable pointer to the field.
    pub fn mut_payload(&mut self) -> &mut ::protobuf::RepeatedField<CollectionId> {
        &mut self.payload
    }

    // Take field
    pub fn take_payload(&mut self) -> ::protobuf::RepeatedField<CollectionId> {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<CollectionId>>(
                    "payload",
                    |m: &CollectionSearchResponse| { &m.payload },
                    |m: &mut CollectionSearchResponse| { &mut m.payload },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x03(\x0b2\r.CollectionIdR\x07payload\";\n\x17CollectionCreateReques\
    ...
    \x01(\x0cR\x0barchiveData2\x9c\x01\n\x04Node\x12I\n\x10CollectionCreate\
